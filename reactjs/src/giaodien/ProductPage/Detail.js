            ...
            <form onSubmit={save}>
              ...
              <div className='price-container'>
                ...
                <div style={{ float: 'left' }}>
                  <p className="detailproduct">Thông tin sản phẩm: </p>
                  <p className="detailproduct">Miễn phí vận chuyển với đơn hàng có giá trị trên 599K</p>
                    <p className="detailproduct">Giao hàng toàn quốc từ 2-4 ngày làm việc</p>
                    <p className="detailproduct">Đổi trả sản phẩm trong 7 ngày, từ ngày nhận được sản phẩm</p>
                    <p className="detailproduct">Hotline & Zalo hỗ trợ KH: 0372454024</p>
